  ...
  const rows: Card = [
    {
      ...
      created: "12:30",
      snippet:"hello lorem dasdadsasda  da da d sa da d a  asdadasd  ",
      avatar:
          ...
          <div className="max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-20">
            ...
            <ul className="mt-16 space-y-5">
              <li className="flex gap-x-2 sm:gap-x-4 ">
                ...
                <div className="bg-white border w-full border-gray-200 rounded-lg p-4 space-y-3 dark:bg-neutral-900 dark:border-neutral-700">
